...
- [ ] Gdy łączysz się do instancji SQL Server po **nazwie hosta** lub FQDN (np. sqlsrv01.SQLMANIAK.com).  
...
```
MSSQLSvc/sqlsrv01.sqlmaniak.com:1433
...
```powershell
setspn -S MSSQLSvc/sqlsrv01.SQLMANIAK.com:1433 SQLMANIAK\gmsa-sql2022$
setspn -S MSSQLSvc/sqlsrv01:1433 SQLMANIAK\gmsa-sql2022$
```

## 4. Weryfikacja SPN
```powershell
setspn -L SQLMANIAK\gmsa-sql2022$
klist
```
