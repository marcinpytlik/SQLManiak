...
IF OBJECT_ID(N'[patch].[SqlBuildCatalog]', N'U') IS NULL
BEGIN
...
IF OBJECT_ID(N'[patch].[InstanceBuildHistory]', N'U') IS NULL
BEGIN
...
IF OBJECT_ID(N'[patch].[PatchAssessment]', N'U') IS NULL
BEGIN
...
IF OBJECT_ID(N'[patch].[PatchException]', N'U') IS NULL
BEGIN
...
IF OBJECT_ID(N'[config].[ServerConfigurationSnapshot]', N'U') IS NULL
BEGIN
...
IF OBJECT_ID(N'[config].[TempdbFileSnapshot]', N'U') IS NULL
BEGIN
...
IF OBJECT_ID(N'[config].[TraceFlagSnapshot]', N'U') IS NULL
BEGIN
...
IF OBJECT_ID(N'[config].[LinkedServerSnapshot]', N'U') IS NULL
BEGIN
...
IF OBJECT_ID(N'[config].[ConfigurationBaseline]', N'U') IS NULL
BEGIN
...
IF OBJECT_ID(N'[config].[ConfigurationBaselineItem]', N'U') IS NULL
BEGIN
...
IF OBJECT_ID(N'[security].[ServerPrincipalSnapshot]', N'U') IS NULL
BEGIN
...
IF OBJECT_ID(N'[security].[ServerRoleMembershipSnapshot]', N'U') IS NULL
BEGIN
...
IF OBJECT_ID(N'[security].[ServerPermissionSnapshot]', N'U') IS NULL
BEGIN
...
IF OBJECT_ID(N'[security].[ProxySnapshot]', N'U') IS NULL
BEGIN
...
IF OBJECT_ID(N'[security].[CredentialSnapshot]', N'U') IS NULL
BEGIN
...
IF OBJECT_ID(N'[security].[DatabaseMailProfileSnapshot]', N'U') IS NULL
BEGIN
...
IF OBJECT_ID(N'[security].[DatabaseMailAccountSnapshot]', N'U') IS NULL
BEGIN
...
IF OBJECT_ID(N'[security].[SecurityFinding]', N'U') IS NULL
BEGIN
...
IF OBJECT_ID(N'[alert].[Rule]', N'U') IS NULL
BEGIN
...
IF OBJECT_ID(N'[alert].[Finding]', N'U') IS NULL
BEGIN
