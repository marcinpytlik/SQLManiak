...
function New-RepositoryConnection {
    ...
    $builder['Application Name'] =
        'DBACentralRepository Confluence Export v2'
...
function Convert-ToSafeFolderName {
    ...
    return Convert-ToSafeFileName -Name $Name
}
...
function Export-ConfluencePage {
    ...
    $folderName =
        Convert-ToSafeFolderName -Name $Section

    $fileName =
        Convert-ToSafeFileName -Name $PageTitle
