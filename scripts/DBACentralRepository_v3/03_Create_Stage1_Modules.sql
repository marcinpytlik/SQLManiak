...
IF OBJECT_ID(N'[backup].[BackupHistory]', N'U') IS NULL
BEGIN
...
IF OBJECT_ID(N'[backup].[BackupFile]', N'U') IS NULL
BEGIN
...
IF OBJECT_ID(N'[backup].[BackupPolicy]', N'U') IS NULL
BEGIN
...
IF OBJECT_ID(N'[backup].[RestoreTest]', N'U') IS NULL
BEGIN
...
IF OBJECT_ID(N'[capacity].[VolumeSnapshot]', N'U') IS NULL
BEGIN
...
IF OBJECT_ID(N'[capacity].[DatabaseGrowthDaily]', N'U') IS NULL
BEGIN
...
IF OBJECT_ID(N'[capacity].[FileGrowthEvent]', N'U') IS NULL
BEGIN
...
IF OBJECT_ID(N'[ha].[AvailabilityGroupSnapshot]', N'U') IS NULL
BEGIN
...
IF OBJECT_ID(N'[ha].[ReplicaSnapshot]', N'U') IS NULL
BEGIN
...
IF OBJECT_ID(N'[ha].[DatabaseReplicaSnapshot]', N'U') IS NULL
BEGIN
...
IF OBJECT_ID(N'[ha].[FailoverHistory]', N'U') IS NULL
BEGIN
...
IF OBJECT_ID(N'[maintenance].[CheckDbExecution]', N'U') IS NULL
BEGIN
...
IF OBJECT_ID(N'[maintenance].[SuspectPageSnapshot]', N'U') IS NULL
BEGIN
...
IF OBJECT_ID(N'[maintenance].[IndexMaintenanceExecution]', N'U') IS NULL
BEGIN
