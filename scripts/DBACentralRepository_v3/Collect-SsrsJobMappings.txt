...
function New-SqlConnection {
    param(
        ...
        [string]$ApplicationName = 'DBACentralRepository SSRS Mapping'
    )
...
foreach ($instance in $instances.Rows) {
    ...
    try {
        $reportDatabases = Invoke-DataTable `
            -ServerInstance $serverInstance `
            -DatabaseName 'master' `
